...
HD_PWD='C:/Zynq_Book/TC_PmodAD1/TC_PmodAD1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_2_2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_2_2_wrapper.tcl -notrace
