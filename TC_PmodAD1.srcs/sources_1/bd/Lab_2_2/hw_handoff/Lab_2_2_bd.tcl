...
################################################################
# This is a generated script based on design: Lab_2_2
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: PmodAD1_0, and set properties
  set PmodAD1_0 [ create_bd_cell -type ip -vlnv digilentinc.com:IP:PmodAD1:1.0 PmodAD1_0 ]
  ...
  connect_bd_intf_net -intf_net PmodAD1_0_Pmod_out [get_bd_intf_ports je] [get_bd_intf_pins PmodAD1_0/Pmod_out]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins PmodAD1_0/AXI_LITE_SAMPLE] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins PmodAD1_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PmodAD1_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodAD1_0/AXI_LITE_SAMPLE/Reg0] SEG_PmodAD1_0_Reg0
